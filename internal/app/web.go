...
func (w *webServer) handleShodanSchedule(rw http.ResponseWriter, r *http.Request) {
	...
	if err := w.shodan.UpdateActiveSchedule(enabled, interval); err != nil {
