...
```bash
curl -fL -o cfnat-linux-v0.16.2.tar.gz \
https://github.com/Jk-z-Box/cfnat-linux/releases/download/v0.16.2/cfnat-linux-v0.16.2.tar.gz

tar -xzf cfnat-linux-v0.16.2.tar.gz
cd cfnat-linux
