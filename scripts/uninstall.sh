...
rm -f /etc/systemd/system/cfnat.service /etc/systemd/system/cfnat-update.service /etc/systemd/system/cfnat-update.timer /usr/local/bin/cfnat /usr/local/bin/cfnatctl
